...
elseif strcmp(dataset, 'VOC2010_Part')
    VOCopts.seg.clsimgpath=[seg_root '/SegmentationPart/%s.png'];
    % link to exper/voc10_part/list
    VOCopts.seg.imgsetpath=[seg_root '/ImageSets/SegmentationPart/%s_id.txt'];
elseif strcmp(dataset, 'VOC2010_Person')
    VOCopts.seg.clsimgpath=[seg_root '/SegmentationPerson/%s.png'];
    % link to exper/voc10_person/list
    VOCopts.seg.imgsetpath=[seg_root '/ImageSets/SegmentationPerson/%s_id.txt'];    
elseif strcmp(dataset, 'cloth_data_6')
    VOCopts.seg.clsimgpath=[seg_root '/SegmentationClass/%s.png'];
    % link to exper/cloth_data_6/list
    VOCopts.seg.imgsetpath=[seg_root '/ImageSets/Segmentation/%s.txt'];
