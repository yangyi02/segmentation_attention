...
def classify_url():
    ...
    return flask.render_template(
        'index2.html', has_result=True, result=result,
...
class ImagenetClassifier(object):
    default_args = {
        'model_def_file': (
            '{}/examples/web_demo/models/part_seg/deploy.prototxt'.format(REPO_DIRNAME)),
        'pretrained_model_file': (
            '{}/examples/web_demo/models/part_seg/train2_iter_8000.caffemodel'.format(REPO_DIRNAME)),
        'model_def_file2': (
            '{}/examples/web_demo/models/yi_cloth_2/deploy.prototxt'.format(REPO_DIRNAME)),
        'pretrained_model_file2': (
            '{}/examples/web_demo/models/yi_cloth_2/train_iter_12000.caffemodel'.format(REPO_DIRNAME)),
        'mean_file': (
