/* copy from https://github.com/BVLC/caffe/pull/1965/files
 * by ducha-aiki
 *
 */
#include <algorithm>
...
TYPED_TEST(BatchNormLayerTest, TestForwardScaleOneShiftZero) {
  typedef typename TypeParam::Dtype Dtype;
...
TYPED_TEST(BatchNormLayerTest, TestForwardScaleOneShiftOne) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  layer_param.mutable_bn_param()->mutable_scale_filler()->set_value(1);
...
TYPED_TEST(BatchNormLayerTest, TestForwardScaleTwoShiftOne) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
...
TYPED_TEST(BatchNormLayerTest, TestGradientShiftZero) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  layer_param.mutable_bn_param()->mutable_scale_filler()->set_value(1);
  layer_param.mutable_bn_param()->mutable_shift_filler()->set_value(0);
...
TYPED_TEST(BatchNormLayerTest, TestGradientShiftOne) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  layer_param.mutable_bn_param()->mutable_scale_filler()->set_value(1);
  layer_param.mutable_bn_param()->mutable_shift_filler()->set_value(1);
...
TYPED_TEST(BatchNormLayerTest, TestGradientScaleTwoShiftOne) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  layer_param.mutable_bn_param()->mutable_scale_filler()->set_value(2);
  layer_param.mutable_bn_param()->mutable_shift_filler()->set_value(1);
...
TYPED_TEST(BatchNormLayerTest, TestGradientGaussianParam) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter layer_param;
  BNParameter* bn_param = layer_param.mutable_bn_param();
  bn_param->mutable_scale_filler()->set_type("gaussian");
  bn_param->mutable_shift_filler()->set_type("gaussian");
  BatchNormLayer<Dtype> layer(layer_param);
  GradientChecker<Dtype> checker(1e-2, 1e-3);
  checker.CheckGradientExhaustive(&layer, this->blob_bottom_vec_,
      this->blob_top_vec_);
