...
template <typename Dtype>
const Dtype* Blob<Dtype>::cpu_data_at(
...
template <typename Dtype>
const Dtype* Blob<Dtype>::gpu_data_at(
    const int n, const int c, const int h, const int w) const {
  CHECK(data_);
...
template <typename Dtype>
const Dtype* Blob<Dtype>::cpu_diff_at(
    const int n, const int c, const int h, const int w) const {
  CHECK(diff_);
...
template <typename Dtype>
const Dtype* Blob<Dtype>::gpu_diff_at(
    const int n, const int c, const int h, const int w) const {
  CHECK(diff_);
...
template <typename Dtype>
Dtype* Blob<Dtype>::mutable_cpu_data_at(
...
template <typename Dtype>
Dtype* Blob<Dtype>::mutable_gpu_data_at(
    const int n, const int c, const int h, const int w) {
  CHECK(data_);
...
template <typename Dtype>
Dtype* Blob<Dtype>::mutable_cpu_diff_at(
    const int n, const int c, const int h, const int w) {
  CHECK(diff_);
...
template <typename Dtype>
Dtype* Blob<Dtype>::mutable_gpu_diff_at(
    const int n, const int c, const int h, const int w) {
  CHECK(diff_);
