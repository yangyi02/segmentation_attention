...
for layer = 1 : numel(trained_net.layer_vec)
    ...
    if layer == surgery_layer_ids(1) 
        ...
        % 7x7x512x4096 -> 3x3x512x512
        param1 = param1(1:3:end, 1:3:end, :, 1:8:end);
        param2 = param2(1:8:end);
    ...
    elseif layer == surgery_layer_ids(2)
        ...
        % 1x1xx4096x4096 -> 1x1x512x512
        param1 = param1(:, :, 1:8:end, 1:8:end);
        param2 = param2(1:8:end);
