...
def classify_url():
    ...
    result, image2, seg, overlay = app.clf.classify_image(image)
    return flask.render_template(
        'index.html', has_result=True, result=result, imagesrc=imageurl, resultsrc=embed_image_html(seg), overlaysrc=embed_image_html(overlay))
...
def classify_upload():
    ...
    return flask.render_template(
        ...
        imagesrc=embed_image_html(image2), resultsrc=embed_image_html(seg), overlaysrc=embed_image_html(overlay))
...
#        'model_def_file': (
#            '{}/examples/net_surgery/bvlc_caffenet_full_conv.prototxt'.format(REPO_DIRNAME)),
#        'pretrained_model_file': (
#            '{}/examples/net_surgery/bvlc_caffenet_full_conv.caffemodel'.format(REPO_DIRNAME)),
#        'model_def_file': (
#            '{}/web_demo/models/voc12/config/vgg128_noup_pool3_20M_largewin_coco_attention13_2/deploy.prototxt'.format(REPO_DIRNAME)),
#        'pretrained_model_file': (
#            '{}/web_demo/models/voc12/model/vgg128_noup_pool3_20M_largewin_coco_attention13_2/train2_iter_8000.caffemodel'.format(REPO_DIRNAME)),
        'model_def_file': (
...
#        'model_def_file': (
#            '{}/examples/web_demo/models/yi_cloth/deploy.prototxt'.format(REPO_DIRNAME)),
#        'pretrained_model_file': (
#            '{}/examples/web_demo/models/yi_cloth/train_iter_12000.caffemodel'.format(REPO_DIRNAME)),
        'mean_file': (
    ...
    def classify_image(self, image):
        try:
            ...
            return (True, '%.3f' % (endtime - starttime)), image2, seg, overlay
